...
Каждое направление имеет уникальный фон с декоративными размытыми элементами, создающими атмосферу и визуальную идентичность.

## 1. Правовой комитет (Legal)

### Основной фон
- **Цвет:** `#1D1E25` (тёмно-серый)

### Декоративные элементы
- **Group 1:**
  - Ellipse 5: `#383B72` (фиолетово-синий), opacity 0.2, blur 600px
  - Ellipse 1: `#383B72`, opacity 0.7, blur 400px
  - Ellipse 3: `#383B72`, opacity 0.6, blur 150px
  - Ellipse 4: `#383B72`, blur 100px
  
- **Group 2:**
  - Ellipse 6: `#3B3F70` (тёмно-фиолетовый), opacity 0.2, blur 600px
  - Ellipse 1: `#3B3F70`, opacity 0.7, blur 400px
  - Ellipse 3: `#3B3F70`, opacity 0.6, blur 150px
  - Ellipse 4: `#3B3F70`, blur 100px

### Градиент
- **Тёмная тема:** `linear-gradient(135deg, #1D1E25 0%, #2A2B35 50%, #1D1E25 100%)`
...
### Декоративные элементы
- **Group 1:**
  - Ellipse 5: `#1E6BAA` (голубой), opacity 0.2, blur 600px
  - Ellipse 1: `#1E6BAA`, opacity 0.7, blur 400px
  - Ellipse 3: `#1E6BAA`, opacity 0.6, blur 150px
  - Ellipse 4: `#1E6BAA`, blur 100px
  
- **Group 2:**
  - Ellipse 6: `#1C809C` (бирюзовый), opacity 0.2, blur 600px
  - Ellipse 1: `#1C809C`, opacity 0.7, blur 400px
  - Ellipse 3: `#1C809C`, opacity 0.6, blur 150px
  - Ellipse 4: `#1C809C`, blur 100px
...
### Основной фон
- **Цвет:** `#251D1D` (тёмно-красный)

### Декоративные элементы
- **Group 1:**
  - Ellipse 5: `#1C9C56` (зелёный), opacity 0.2, blur 600px
  - Ellipse 1: `#1C9C56`, opacity 0.7, blur 400px
  - Ellipse 3: `#1C9C56`, opacity 0.6, blur 150px
  - Ellipse 4: `#1C9C56`, blur 100px
  
- **Group 2:**
  - Ellipse 6: `#1C9C65` (светло-зелёный), opacity 0.2, blur 600px
  - Ellipse 1: `#1C9C65`, opacity 0.7, blur 400px
