...
3. **Environment Variables** — скопировать с прод-проекта (Supabase, NextAuth, `NEXT_PUBLIC_*` и т.д.), если все варианты используют один бэкенд.
4. При необходимости отдельный домен/поддомен на проект.
