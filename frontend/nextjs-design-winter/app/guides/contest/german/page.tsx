...
export const metadata: Metadata = {
  title: 'Конкурс гайдов · Герман | ОСС ДВФУ',
  description: 'Демо-страница дизайна Германа — в разработке.',
};

export default function ContestGermanPage() {
  return (
    <main className="max-w-2xl mx-auto px-4 sm:px-6 py-12 sm:py-16 text-center">
      ...
      <h1 className="mt-2 text-2xl font-bold light:text-gray-900">Герман</h1>
      <p className="mt-4 text-white/70 light:text-gray-600">
        ...
        <code className="text-sm text-oss-red">GuideSkinGerman</code>.
      </p>
