...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-transparent text-white light:text-gray-900 animate-page-enter winter-main concept-direction-home">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12 concept-direction-chapters-section">
        <div className="flex items-end justify-between gap-4 flex-wrap mb-8">
          <div className="animate-fade-in-up">
            <h2 className="text-xl sm:text-2xl font-semibold text-white light:text-gray-900 light:font-bold concept-direction-chapters-heading">Направления</h2>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 pb-12 sm:pb-16 concept-direction-chapters-section">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          <div className="lg:col-span-2">
            <div className="flex items-end justify-between gap-4 flex-wrap mb-6">
              <div>
                <h2 className="text-xl sm:text-2xl font-semibold text-white light:text-gray-900 concept-direction-chapters-heading">Новости и гайды</h2>
